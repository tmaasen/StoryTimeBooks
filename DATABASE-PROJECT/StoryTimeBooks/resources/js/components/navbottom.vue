          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="widget subscribe no-box">
              ...
              <p>
                ...
                at College of the Ozarks stay safe until we meet again on campus.
              </p>
            </div>
          </div>
            ...
            <div class="widget no-box">
              ...
              <ul class="thumbnail-widget">
                ...
                <li>
                  <div class="thumb-content">
                    <a
                      href="http://www.cofo.edu/Page/About-College-of-the-Ozarks/Novel-Coronavirus-COVID-19.2544.html"
                      target="_blank"
                    >NEWS</a>
                  </div>
                </li>
